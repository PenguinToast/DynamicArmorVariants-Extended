...
auto GetDisplayName(RE::StaticFunctionTag *, std::string a_variant)
    -> std::string;

void ApplyVariant(RE::StaticFunctionTag *, RE::Actor *a_actor,
                  std::string a_variant);

void ResetVariant(RE::StaticFunctionTag *, RE::Actor *a_actor,
