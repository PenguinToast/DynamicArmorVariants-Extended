...
public:
  ...
  static auto LookupActorValue(const std::string &a_uppercase)
      -> RE::ActorValue {
    if (auto it = ActorValueLookup.find(a_uppercase);
        it != ActorValueLookup.end()) {
      return it->second;
    } else {
...
private:
  inline static const std::unordered_map<std::string, RE::ActorValue>
      ActorValueLookup{
          ...
          {"BYPASSVENDORSTOLENCHECK"s,
           RE::ActorValue::kBypassVendorStolenCheck},
          {"BYPASSVENDORKEYWORDCHECK"s,
           RE::ActorValue::kBypassVendorKeywordCheck},
          ...
          {"LOCKPICKINGSKILLADVANCE"s,
           RE::ActorValue::kLockpickingSkillAdvance},
          {"SNEAKSKILLADVANCE"s, RE::ActorValue::kSneakingSkillAdvance},
          {"ALCHEMYSKILLADVANCE"s, RE::ActorValue::kAlchemySkillAdvance},
          {"SPEECHCRAFTSKILLADVANCE"s,
           RE::ActorValue::kSpeechcraftSkillAdvance},
          {"ALTERATIONSKILLADVANCE"s, RE::ActorValue::kAlterationSkillAdvance},
          {"CONJURATIONSKILLADVANCE"s,
           RE::ActorValue::kConjurationSkillAdvance},
          {"DESTRUCTIONSKILLADVANCE"s,
           RE::ActorValue::kDestructionSkillAdvance},
          {"ILLUSIONSKILLADVANCE"s, RE::ActorValue::kIllusionSkillAdvance},
          {"RESTORATIONSKILLADVANCE"s,
           RE::ActorValue::kRestorationSkillAdvance},
          ...
          {"COMBATHEALTHREGENMULT"s,
           RE::ActorValue::kCombatHealthRegenMultiply},
