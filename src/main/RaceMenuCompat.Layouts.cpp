...
constexpr std::array<std::uint8_t, 19> kVisitAllWornItemsSlotMatchPrologue_0345_VR{
    0x48, 0x8B, 0x17, 0x48, 0x8D, 0x4C, 0x24, 0x40, 0x48, 0x8B,
    0x44, 0x24, 0x40, 0xFF, 0x10, 0x84, 0xC0, 0x74, 0x43};
constexpr std::array<std::uint8_t, 23> kVisitAllWornItemsSlotMatchPrologue_0345_SE{
    0x49, 0x8B, 0x17, 0x48, 0x8D, 0x4C, 0x24, 0x28, 0x48, 0x8B,
    0x44, 0x24, 0x28, 0xFF, 0x10, 0x84, 0xC0, 0x0F, 0x84, 0xD5,
    0x00, 0x00, 0x00};
constexpr std::array<std::uint8_t, 23> kVisitAllWornItemsSlotMatchPrologue_0419_9{
    0x49, 0x8B, 0x17, 0x48, 0x8D, 0x4C, 0x24, 0x28, 0x48, 0x8B,
    0x44, 0x24, 0x28, 0xFF, 0x10, 0x84, 0xC0, 0x0F, 0x84, 0xD5,
    0x00, 0x00, 0x00};
constexpr std::array<std::uint8_t, 23> kVisitAllWornItemsSlotMatchPrologue_0419_13{
    0x48, 0x8B, 0x44, 0x24, 0x28, 0x49, 0x8B, 0x17, 0x48, 0x8D,
    0x4C, 0x24, 0x28, 0xFF, 0x10, 0x84, 0xC0, 0x0F, 0x84, 0xD5,
    0x00, 0x00, 0x00};
constexpr std::array<std::uint8_t, 19> kVisitAllWornItemsSlotMatchPrologue_0419_15{
