...
public:
	...
	static auto RegisterVariantJson(std::string_view a_name, std::string_view a_variantJson) -> bool;
	static auto DeleteVariant(std::string_view a_name) -> bool;
	static auto SetVariantConditionsJson(std::string_view a_variant, std::string_view a_conditionsJson) -> bool;

private:
	static auto ParseJson(std::string_view a_jsonText, Json::Value& a_root) -> bool;
	static auto BuildRefMap(const Json::Value& a_refs) -> ConditionParser::RefMap;
	static auto ParseOverrideOption(const Json::Value& a_overrideHead) -> ArmorVariant::OverrideOption;
	static auto BuildArmorVariant(const Json::Value& a_variantJson, ArmorVariant& a_variant) -> bool;
	static auto NormalizeConditionsPayload(
